...
for i in company_list:
    ...
    document.add_picture("S:\\Desktop\\素材\\1.1.jpg", width=Inches(6))
    # 在文件最上头插入图片作为文件红头，宽度为6英尺
    ...
    table_run1 = table.cell(0, 0).paragraphs[0].add_run("XXX产品报价表")
    ...
    run4 = p4.add_run("  (联系人： 小杨        电话：13362345914)  ")
